...
internal sealed class CompanyService : ICompanyService
{
    ...
    private async Task<Company> GetCompanyAndCheckIfExistsAsync(Guid id, bool trackChanges)
    {
    ...
    {
        var company = await GetCompanyAndCheckIfExistsAsync(id, trackChanges);
    ...
    {
        var company = await GetCompanyAndCheckIfExistsAsync(companyId, trackChanges);
    ...
    {
        var companyEntity = await GetCompanyAndCheckIfExistsAsync(companyId, trackChanges);
